...
def get_rgbd_tuples(filepath, model, batch_size=128):
    svo_files = []
    ...
    # for i, camera in enumerate(cameras[:1]): ### DEBUG ###
        ...
        for k in trange(len(cam_left_rgb_im_traj) // batch_size + 1):
        # for k in trange(20): ### DEBUG ###
...
if __name__ == "__main__":
    r2d2_data_path = "/home/kylehatch/Desktop/r2d2/R2D2_/r2d2_data_subset/lab-uploads/AUTOLab/success/2023-07-07"
    save_path = "/home/kylehatch/Desktop/r2d2/r2d2/png_data"
    stereo_ckpt = "/home/kylehatch/Desktop/r2d2/R2D2_/jupyter_notebooks/stereo_20230724.pt"
    ...
    for i, traj_name in enumerate(os.listdir(r2d2_data_path)):
        ...
        left_rgb_im_traj, right_rgb_im_traj, tri_depth_im_traj, serial_numbers, frame_count, cam_matrices = get_rgbd_tuples(svo_path, model, batch_size=1)
        # left_rgb_im_traj, right_rgb_im_traj, tri_depth_im_traj, serial_numbers, frame_count, cam_matrices = get_rgbd_tuples(svo_path, stereo_ckpt, batch_size=1)
        ...
        # ### DEBUG ###
        # combined_extrinsics = combined_extrinsics[:left_rgb_im_traj.shape[0]]
        # actions = actions[:left_rgb_im_traj.shape[0]]
